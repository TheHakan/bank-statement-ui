      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 pt-6 pb-16 sm:px-6 lg:px-8">
        ...
        <section className="mt-8 flex flex-1 flex-col items-start justify-center gap-6 md:mt-16 md:gap-10 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-4 md:space-y-6">
            <p className="inline-flex items-center gap-2 rounded-full border border-sky-500/30 bg-sky-500/10 px-3 py-1 text-xs uppercase tracking-[0.2em] text-sky-600 dark:text-sky-300">
              SaaS for bank statements
            </p>

            <h1 className="text-2xl font-semibold leading-tight text-slate-900 dark:text-slate-100 sm:text-3xl md:text-4xl lg:text-5xl">
              Convert{" "}
              <span className="bg-linear-to-r from-sky-500 to-cyan-400 dark:from-sky-400 dark:to-cyan-300 bg-clip-text text-transparent">
                bank statements
              </span>{" "}
            ...
            <div className="flex flex-col items-start gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
              <Link
                href="/register"
                className="w-full rounded-xl bg-sky-500 px-5 py-2.5 text-center text-sm font-medium text-white shadow-lg shadow-sky-500/30 hover:bg-sky-400 sm:w-auto"
              >
                Start free trial
              </Link>
              <Link
                href="/dashboard"
                className="text-sm text-slate-700 hover:text-sky-500 dark:text-slate-300 dark:hover:text-sky-300"
              >
                View dashboard demo →
              </Link>
            </div>
          ...
          <div className="mt-8 w-full flex-1 md:mt-10 lg:mt-0">
            <div className="relative rounded-3xl border border-slate-300 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/70 p-4 shadow-2xl backdrop-blur">
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-3 gap-3">
                  <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/80 p-3">
                    <p className="text-[11px] text-slate-500 dark:text-slate-500">Total inflow</p>
                    <p className="mt-1 text-sm font-semibold text-emerald-600 dark:text-emerald-300">
                      $82,430
                    </p>
                  </div>
                  <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/80 p-3">
                    <p className="text-[11px] text-slate-500 dark:text-slate-500">Total outflow</p>
                    <p className="mt-1 text-sm font-semibold text-rose-600 dark:text-rose-300">
                      $63,210
                    </p>
                  </div>
                  <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/80 p-3">
                    <p className="text-[11px] text-slate-500 dark:text-slate-500">Net balance</p>
                    <p className="mt-1 text-sm font-semibold text-sky-600 dark:text-sky-300">
                      $19,220
                    </p>
                  </div>
                </div>

                <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/80 p-3 text-[11px] text-slate-600 dark:text-slate-400">
                  <p>Recent transactions</p>
                  <div className="mt-2 space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span>Payroll deposit</span>
                      <span className="text-emerald-600 dark:text-emerald-300">+$5,200</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span>Office supplies</span>
                      <span className="text-rose-600 dark:text-rose-300">-$340</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span>Client payment</span>
                      <span className="text-emerald-600 dark:text-emerald-300">+$8,500</span>
                    </div>
                  </div>
                </div>
              </div>

              <div className="mt-4 flex items-center justify-between border-t border-slate-200 dark:border-slate-800 pt-3 text-[11px] text-slate-500 dark:text-slate-500">
        ...
        <section id="features" className="mt-12 space-y-6 md:mt-20 md:space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-5">
              <h3 className="font-medium text-slate-900 dark:text-slate-100">Automatic Data Extraction</h3>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-5">
              <h3 className="font-medium text-slate-900 dark:text-slate-100">Multi-Bank Support</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-5">
              <h3 className="font-medium text-slate-900 dark:text-slate-100">Secure Processing</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <section id="how-it-works" className="mt-12 border-t border-slate-200 dark:border-slate-800 pt-8 md:mt-16 md:pt-12">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 md:text-2xl">
          ...
          <div className="mt-6 space-y-4 md:mt-8 md:space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-medium text-slate-900 dark:text-slate-100">Upload Your Bank Statement PDF</h3>
            ...
            <div className="flex gap-4">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-sky-500/20 text-sm font-semibold text-sky-600 dark:text-sky-300">
                2
              </div>
              <div>
                <h3 className="font-medium text-slate-900 dark:text-slate-100">Automatic Transaction Parsing</h3>
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-medium text-slate-900 dark:text-slate-100">Download Excel Spreadsheet</h3>
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
        ...
        <section className="mt-12 md:mt-16">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 md:mt-6 md:gap-4">
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-medium text-slate-900 dark:text-slate-200 text-sm">Save Hours of Manual Data Entry</p>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Eliminate tedious copy-paste work</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-emerald-600 dark:text-emerald-400">✓</div>
              <div>
                <p className="font-medium text-slate-900 dark:text-slate-200 text-sm">Reduce Human Errors</p>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Automated extraction ensures accuracy</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-emerald-600 dark:text-emerald-400">✓</div>
              <div>
                <p className="font-medium text-slate-900 dark:text-slate-200 text-sm">Process Multiple Statements</p>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Batch convert dozens of PDFs at once</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-emerald-600 dark:text-emerald-400">✓</div>
              <div>
                <p className="font-medium text-slate-900 dark:text-slate-200 text-sm">Export to Any Format</p>
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Excel, CSV, JSON, or direct API access</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="mt-12 md:mt-16">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 md:mt-8 md:gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-6">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Starter</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400">Perfect for individuals</p>
              <div className="mt-4">
                <span className="text-3xl font-bold text-slate-900 dark:text-slate-100">$9</span>
              ...
              <button className="mt-6 w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 py-2 text-sm font-medium text-slate-900 dark:text-slate-100 hover:bg-slate-200 dark:hover:bg-slate-750">
                Start free trial
              </button>
            </div>

            {/* Professional Plan */}
            <div className="rounded-2xl border-2 border-sky-500 bg-slate-50 dark:bg-slate-900/50 p-6 relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="rounded-full bg-sky-500 px-3 py-1 text-[10px] font-semibold text-white">
                  MOST POPULAR
                </span>
              </div>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Professional</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400">For small businesses</p>
              <div className="mt-4">
                <span className="text-3xl font-bold text-slate-900 dark:text-slate-100">$29</span>
                <span className="text-slate-600 dark:text-slate-400 text-sm">/month</span>
              </div>
              <ul className="mt-6 space-y-3 text-xs text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-2">
              ...
              <button className="mt-6 w-full rounded-lg bg-sky-500 py-2 text-sm font-medium text-white hover:bg-sky-400">
                Start free trial
              </button>
            </div>
            ...
            {/* Enterprise Plan */}
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-6">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Enterprise</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400">For large organizations</p>
              <div className="mt-4">
                <span className="text-3xl font-bold text-slate-900 dark:text-slate-100">Custom</span>
              </div>
              <ul className="mt-6 space-y-3 text-xs text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
        ...
        <section className="mt-12 md:mt-16">
          ...
          <p className="mt-3 text-sm text-slate-600 dark:text-slate-400 max-w-3xl">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 md:mt-8 md:gap-6">
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              <h3 className="font-semibold text-slate-900 dark:text-slate-100">Accountants & Bookkeepers</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              <h3 className="font-semibold text-slate-900 dark:text-slate-100">Small Business Owners</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              <h3 className="font-semibold text-slate-900 dark:text-slate-100">Financial Analysts</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              <h3 className="font-semibold text-slate-900 dark:text-slate-100">Loan Officers & Underwriters</h3>
              <p className="mt-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <section className="mt-12 md:mt-16">
          ...
          <div className="mt-6 space-y-3 md:mt-8 md:space-y-4">
            <details className="group rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              <summary className="cursor-pointer font-medium text-slate-900 dark:text-slate-100 text-sm list-none flex items-center justify-between">
                How accurate is the bank statement converter?
                <span className="text-slate-600 dark:text-slate-400 group-open:rotate-180 transition-transform">▼</span>
              </summary>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 md:mt-8 md:gap-6 lg:grid-cols-3">
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              ...
              <div className="mt-4 flex items-center gap-3">
                <div className="h-8 w-8 rounded-full bg-sky-500/20 flex items-center justify-center text-xs font-semibold text-sky-600 dark:text-sky-300">
                  SA
                </div>
                <div>
                  <p className="text-xs font-medium text-slate-900 dark:text-slate-200">Sarah Anderson</p>
                  <p className="text-[10px] text-slate-600 dark:text-slate-500">Senior Accountant</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              ...
              <div className="mt-4 flex items-center gap-3">
                <div className="h-8 w-8 rounded-full bg-emerald-500/20 flex items-center justify-center text-xs font-semibold text-emerald-600 dark:text-emerald-300">
                  MJ
                </div>
                <div>
                  <p className="text-xs font-medium text-slate-900 dark:text-slate-200">Michael Johnson</p>
                  <p className="text-[10px] text-slate-600 dark:text-slate-500">Business Owner</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 p-5">
              ...
              <div className="mt-4 flex items-center gap-3">
                <div className="h-8 w-8 rounded-full bg-purple-500/20 flex items-center justify-center text-xs font-semibold text-purple-600 dark:text-purple-300">
                  EL
                </div>
                <div>
                  <p className="text-xs font-medium text-slate-900 dark:text-slate-200">Emily Lopez</p>
                  <p className="text-[10px] text-slate-600 dark:text-slate-500">Loan Officer</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mt-12 rounded-2xl border border-sky-500/30 bg-linear-to-br from-sky-500/10 to-cyan-500/10 p-6 text-center md:mt-16 md:p-8">
          ...
          <p className="mt-3 text-sm text-slate-700 dark:text-slate-300 max-w-2xl mx-auto">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:flex-wrap sm:gap-4">
            <Link
              href="/#register"
              className="w-full rounded-xl bg-sky-500 px-6 py-3 text-sm font-medium text-white shadow-lg shadow-sky-500/30 hover:bg-sky-400 sm:w-auto"
            >
              Start free trial
            </Link>
            <Link
              href="/#pricing"
              className="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-900/50 px-6 py-3 text-sm font-medium text-slate-900 dark:text-slate-100 hover:bg-slate-200 dark:hover:bg-slate-800 sm:w-auto"
            >
              View pricing
            </Link>
          </div>
